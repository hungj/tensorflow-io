...
# the License.
# ==============================================================================
"""FDSDataset benchmark from provided schema file."""

import pytest

from tests.test_fds_avro.utils.fds_benchmark_utils import \
  convert_schema_to_data_source, run_fds_benchmark_from_data_source
...
def test_from_schema_file(schemafile, batch_size, benchmark):
  ...
  run_fds_benchmark_from_data_source(data_source, batch_size, benchmark, codec="deflate")
