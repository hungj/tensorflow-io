...
# the License.
# ==============================================================================
"""FDS benchmark with parallelism."""
...
def test_parallelism(batch_size, shuffle_buffer_size, codec, parallelism, benchmark):
  ...
  run_fds_benchmark_from_data_source(data_source, batch_size, benchmark, parallelism=parallelism, codec=codec,
...
def test_parallelism_with_interleave(batch_size, shuffle_buffer_size, parallelism, interleave, benchmark):
  ...
  run_fds_benchmark_from_data_source(data_source, batch_size, benchmark, parallelism=parallelism, interleave_parallelism=interleave,
