...
def test_in_ops_shuffle(batch_size, shuffle_buffer_size, benchmark):
  ...
  run_fds_benchmark_from_data_source(data_source, batch_size, benchmark, shuffle_buffer_size=shuffle_buffer_size)
...
def test_unbatch_shuffle_batch(batch_size, shuffle_buffer_size, benchmark):
  ...
  with FDSWriter(codec="null") as writer:
