...
==============================================================================*/
#ifndef TENSORFLOW_DATA_CORE_KERNELS_FDS_DATASET_OP_H_
#define TENSORFLOW_DATA_CORE_KERNELS_FDS_DATASET_OP_H_
...
class FDSDatasetOp : public DatasetOpKernel {
 public:
  static constexpr const char* const kDatasetType = "FDSDatum";
  ...
  explicit FDSDatasetOp(OpKernelConstruction* ctx);
...
#endif  // TENSORFLOW_DATA_CORE_KERNELS_FDS_DATASET_OP_H_
