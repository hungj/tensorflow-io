#ifndef TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_DECODER_TEST_UTIL_H_
#define TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_DECODER_TEST_UTIL_H_
...
class FDSSchemaBuilder {
  public:
    FDSSchemaBuilder();

    FDSSchemaBuilder& AddDenseFeature(const string& name, DataType dtype, size_t rank, const avro::Type avro_type = avro::AVRO_NULL);
    FDSSchemaBuilder& AddSparseFeature(const string& name, DataType dtype, size_t rank, const avro::Type avro_type = avro::AVRO_NULL);
    FDSSchemaBuilder& AddSparseFeature(const string& name, DataType dtype,
                                       const std::vector<size_t>& order, const avro::Type avro_type = avro::AVRO_NULL);
    FDSSchemaBuilder& AddOpaqueContextualFeature(const string& name, const string& type);
...
#endif // TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_DECODER_TEST_UTIL_H_
