#ifndef TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_SPARSE_VALUE_BUFFER_H_
#define TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_SPARSE_VALUE_BUFFER_H_
...
#endif // TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_SPARSE_VALUE_BUFFER_H_
