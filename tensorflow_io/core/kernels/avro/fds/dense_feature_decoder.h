#ifndef TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_DENSE_FEATURE_DECODER_H_
#define TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_DENSE_FEATURE_DECODER_H_
...
#endif // TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_DENSE_FEATURE_DECODER_H_
