#ifndef TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_AVRO_DECODER_TEMPLATE_H_
#define TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_AVRO_DECODER_TEMPLATE_H_
...
#endif // TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_AVRO_DECODER_TEMPLATE_H_
