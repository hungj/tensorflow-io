#ifndef TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_AVRO_BLOCK_READER_H_
#define TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_AVRO_BLOCK_READER_H_
...
#endif // TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_AVRO_BLOCK_READER_H_
