#ifndef TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_ERRORS_H_
#define TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_ERRORS_H_
...
Status FDSNotRecordError(const string& type, const string& schema);
...
#endif // TENSORFLOW_DATA_CORE_KERNELS_AVRO_FDS_ERRORS_H_
